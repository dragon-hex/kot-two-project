...
class kotSharedCore:
    ...
    def setupWindowByData(self, whatData):
        """setupWindowByData: basic configures the data.
        the icon needs to be already loaded as a surface!
        See: provider.buildWindowData"""
        self.window.icon = whatData['icon']
        self.window.caption = whatData['title']
        self.window.windowUpdateProperties()
